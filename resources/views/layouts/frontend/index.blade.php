        ...
        <div class="row">
         <div class="col-md-2 col-sm-6 ts-facts">
              ...
              {{-- <div class="ts-facts-content"> --}}
                <h3 class="ts-facts-num" ><a href="https://kotamadiun.lapor.go.id/">LAPOR</a></h3>
              {{-- </div> --}}
          </div><!-- Col end -->
          ...
          <div class="col-md-2 col-sm-6 ts-facts mt-5 mt-sm-0">
            <div class="ts-facts-img">
              ...
              {{-- <div class="ts-facts-content"> --}}
                <h3 class="ts-facts-num" ><a class="counterUp" href="https://elhkpn.kpk.go.id/">ELHKPN</a></h3>
              {{-- </div> --}}
          </div><!-- Col end -->
          ...
          <div class="col-md-2 col-sm-6 ts-facts mt-5 mt-sm-0">
            <div class="ts-facts-img">
              ...
              {{-- <div class="ts-facts-content"> --}}
                <h3 class="ts-facts-num" ><a class="counterUp" href="https://lpse.madiunkota.go.id/eproc4/">LPSE</a></h3>
              {{-- </div> --}}
          </div><!-- Col end -->
          <div class="col-md-2 col-sm-6 ts-facts mt-5 mt-sm-0">
            <div class="ts-facts-img">
              ...
              {{-- <div class="ts-facts-content"> --}}
                <h3 class="ts-facts-num" ><a class="counterUp" href="https://covid19.madiunkota.go.id/">COVID</a></h3>
              {{-- </div> --}}
          </div><!-- Col end -->
