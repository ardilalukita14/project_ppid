...
<div class="breadcrumbs" style="background-color: #EEF9FF; height: 90px;">
        <div class="container" >
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2 style="font-weight: 200;">Cek Status Pengajuan Keberatan Informasi</h2>
            </div>
...
<section id="blog" class="blog">
        ...
        <form id="contact-form" class="form-valide" action="{{route('statuspengajuan-keberatan.store')}}" method="POST" enctype="multipart/form-data" role="form">
            {{csrf_field()}}
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input class="form-control form-control-email" name="nik_nip" id="nik_nip" placeholder="NIK" type="integer" required>
              </div>
            </div>
          </div>
          <div class="text-left"><br>
            <button class="btn btn-primary solid blank" type="submit">Cek Status</button>
          </div>
        </form>
