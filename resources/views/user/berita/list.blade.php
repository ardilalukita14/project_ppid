    ...
    <div class="row">
      <div class="col-lg-8">
        @if (count($news) != 0)
                                      ...
                                      <div class="post-meta">
                                        ...
                                        {{-- <small class="post-comment"><i class="far fa-comment text-primary me-2"></i> 03<a href="#"
                                            ...
                                            <div class="entry-title" >
                                              <p class="title" style="margin-left: 15px; margin-right:15px">
                                                <?php $date = DateTime::createFromFormat("Y-m-d", $berita->tgl_post);?>
                                                <a href="{{ route('contents_blog', ['year'=>$date->format("Y"), 'month' => $date->format("m") , 'day' => $date->format("d"), 'slug'=>$berita->slug] ) }}">{!!substr($berita->judul,0,80)!!}...</a>
                                              </p>
                                            </div>
                                      </div>
                                  </div>
          ...
          <div class="blog-pagination" style="margin-top:50px;">
