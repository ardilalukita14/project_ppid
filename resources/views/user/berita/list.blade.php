       ...
       @foreach ($news as $berita)
        <div class="post">
          <div class="post-media post-image">
                ...
                <?php }else{ ?>
                        <img loading="lazy" src="{{ route('menu.file', encrypt($berita->thumbnail)) }}" alt="Gambar Content" class="img-fluid" style="width:800px; height:400px; text-align: center;">
                <?php } ?>
          </div>
          <div class="post-body">
            <div class="entry-header">
              <div class="post-meta">
                <span class="post-author">
                  <i class="far fa-user"></i><a href="#"> {{ $berita->users->name }}</a>
                </span>
                <span class="post-cat">
                  <i class="far fa-folder-open"></i><a href="#"> {{ $berita->kategori->nama_kategori }}</a>
                </span>
                <span class="post-comment"><i class="far fa-calendar"></i> {{ date('d M Y', strtotime($berita->tgl_post)) }}</span>
              </div>
