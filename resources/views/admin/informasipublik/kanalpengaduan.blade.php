...
<head>
  ...
  <title>Kanal Pengaduan | PPID Kota Madiun</title>
        ...
        <div class="col-sm-10">
            <div class="card" style="padding-left:20px; padding-right:20px; padding-top:20px;">
                ...
                <br>
                    ...
                    <form class="form-valide" action="{{route('admin.kanalpengaduan.update')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}

                            <div class="form-group row">
                                <label class="col-lg-8 col-form-label" for="kategori_profile">Nama Kategori</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="kategori_profile" name="kategori_profile" required="" value="{{ $pengaduan->kategori_profile }}" disabled>
                                    <input type="hidden" class="form-control" name="kategori_profile" value="{{ $pengaduan->kategori_profile }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-6 col-form-label" for="title">Judul</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="title" name="title" value="{{$pengaduan->title}}">
                                </div>
                            </div>
                            <div class="form-group row">
