        ...
        <div class="col-sm-10">
            <div class="card" style="padding-left:20px; padding-right:20px; padding-top:20px;">
                ...
                <br>
                    ...
                    <form class="form-valide" action="{{route('admin.tags.store')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}

                            <div class="form-group row">
                                <label class="col-lg-8 col-form-label" for="jenis_tag">Jenis Tags</label>
                                <div class="col-sm-12">
                                    <input type="text" id="jenis_tag" name="jenis_tag" class="form-control" required="" placeholder="Jenis Tag" >
                                </div>
                            </div>
                            <div class="form-group row">
