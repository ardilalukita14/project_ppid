        ...
        <div class="col-sm-10">
            <div class="card" style="padding-left:20px; padding-right:20px; padding-top:20px;">
                ...
                <br>
                    ...
                    <form class="form-valide" action="{{route('informasi_publik.daftar_informasi.pelaksana.create')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}

                            <div class="form-group row">
                                <label class="col-lg-6 col-form-label" for="ppid">PPID Pembantu</label>
                                <div class="col-sm-12">
                                    <input type="text" id="ppid" name="ppid" class="form-control" required="" placeholder="PPID Pembantu"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
