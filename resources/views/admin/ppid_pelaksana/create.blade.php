        ...
        <div class="col-sm-10">
            <div class="card" style="padding-left:20px; padding-right:20px; padding-top:20px;">
                ...
                <br>
                    ...
                    <form class="form-valide" action="{{route('ppid.pelaksana.create')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}

                            <div class="form-group row">
                                <label class="col-lg-8 col-form-label" for="nama_opd">Nama OPD</label>
                                <div class="col-sm-12">
                                    <input type="text" id="nama_opd" name="nama_opd" class="form-control" required="" placeholder="Nama OPD" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-6 col-form-label" for="alamat">Alamat</label>
                                <div class="col-sm-12">
                                    <textarea class="summernote" name="alamat" class="form-control" required="" placeholder="Alamat" ></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-6 col-form-label" for="telepon">Telepon</label>
                                <div class="col-sm-12">
                                    <textarea class="summernote" style="height:10px;" name="telepon" class="form-control" required="" placeholder="Nomor Telepon"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
