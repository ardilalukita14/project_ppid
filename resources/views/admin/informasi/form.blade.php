        ...
        <div class="col-sm-10">
            <div class="card" style="padding-left:20px; padding-right:20px; padding-top:20px;">
                ...
                <br>
                    ...
                    <form class="form-valide" action="{{route('information.create')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}

                            <div class="form-group row">
                                <label class="col-lg-8 col-form-label" for="kategori_informasi">Nama Kategori</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="kategori_informasi" name="kategori_informasi" required="" value="{{ $information->kategori_informasi }}" disabled>
                                    <input type="hidden" class="form-control" name="kategori_informasi" value="{{ $information->kategori_informasi }}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <hr>
                                ...
                                <td style=" text-align:center;">
                                    <a href="{{ route('admin.destroy_berkas_informasi', encrypt($data->id)) }}">  <button type="button"  class="btn btn-danger btn-xs"><i class="fas fa-trash icon-lg"></i> Hapus</button></a>
                                </td>
                                </tr>
                                @endforeach
                                </table>
